...
- **Run `code-quality` on every code change, and `app-sec` on anything touching server
  code, auth, entities, migrations or outbound HTTP — before you report the task complete,
