...
Flow runs have a maximum log size (default **25 MB**). When a run gets close to this limit, Qadam Flow tries to keep it under the cap by truncating large step **inputs** — you'll see `(truncated)` in place of the original value.
