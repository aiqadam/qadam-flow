...
<Tip>
  These benchmarks run in `SANDBOX_CODE_ONLY` mode. This does **not** represent the performance of Qadam Flow Cloud, which uses a different sandboxing mechanism to support multi-tenancy. For more information, see [Sandboxing](/install/architecture/sandboxing).
</Tip>
