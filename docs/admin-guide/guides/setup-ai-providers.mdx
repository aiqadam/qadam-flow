...
AI providers are configured by the platform admin to centrally manage credentials and access, making AI qadams (OpenAI, Anthropic, Gemini, etc.) and their features available to everyone in all projects.
