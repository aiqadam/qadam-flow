---
title: "SCIM Overview"
description: "Automate user lifecycle management with SCIM in Qadam Flow."
---
...
SCIM (System for Cross-domain Identity Management) lets your identity provider automatically create, update, and deactivate users in Qadam Flow.
...
<CardGroup cols={2}>
  <Card title="Okta" icon="shield-check" href="./providers/okta">
    Configure SCIM provisioning from Okta to Qadam Flow.
  </Card>
</CardGroup>
