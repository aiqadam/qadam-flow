---
title: "1Password"
description: "Connect 1Password to Qadam Flow for centralized secret management"
---
...
3. Give it a name (e.g. `Qadam Flow`).
4. Grant it **Read Items** access on the vaults Qadam Flow needs to access.
...
Qadam Flow will retrieve the secret value from 1Password and inject it into the connection at runtime.
