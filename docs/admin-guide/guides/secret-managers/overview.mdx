...
Secret Managers allow you to integrate external secret management systems with Qadam Flow, enabling centralized credential management and enhanced security for your global connections.
...
Once connected, you can reference secrets from your secret managers when configuring qadam connections:
...
- When the flow runs, Qadam Flow authenticates with your secret manager and retrieves the secret
- Secrets are fetched on-demand and never stored in Qadam Flow
...
- **Network Security**: Ensure your secret manager is accessible from your Qadam Flow instance
...
- Ensure network connectivity between Qadam Flow and your secret manager
