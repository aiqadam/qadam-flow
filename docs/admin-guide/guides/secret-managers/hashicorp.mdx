...
description: "Connect HashiCorp Vault to Qadam Flow for enterprise-grade secret management"
---
...
Before connecting HashiCorp Vault to Qadam Flow, ensure you have:
...
Once the connection is saved, you can reference Vault secrets inside any qadam connection dialog — in global connections (Platform Admin) or directly in the flow builder.
