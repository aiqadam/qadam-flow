...
description: "Documentation on project permissions in Qadam Flow"
icon: 'user'
---

<Snippet file="enterprise-feature.mdx" />

Qadam Flow utilizes Role-Based Access Control (RBAC) for managing permissions within projects. Each project consists of multiple flows and users, with each user assigned specific roles that define their actions within the project.

## Default Roles

Qadam Flow comes with four standard roles out of the box. The table below shows the permissions for each role:
