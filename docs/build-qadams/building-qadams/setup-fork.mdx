...
To start building qadams, we need to fork the repository that contains the framework library and the development environment. Later, we will publish these qadams as `npm` artifacts.
...
<Tip>
If you are an enterprise customer and want to use the private qadams feature, you can refer to the tutorial on how to set up a [private fork](../misc/private-fork).
</Tip>