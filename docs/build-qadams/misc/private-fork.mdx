...
<Tip>
For private qadam installation, you will need the paid edition. However, you can still develop qadams, contribute them back, **OR** publish them to the public npm registry and use them in your own instance or project.
</Tip>

## Create a Private Fork (Private Qadams)
...
Conflict resolution should not be necessary since you've only added qadams to your repository.