...
export const createNewIssue = createTrigger({
    ...
    name: string, // Unique name across the qadam.
...
The Context object contains multiple helpful qadams of information and tools that can be useful while developing.
