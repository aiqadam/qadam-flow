...
This is a property that lets you inject JS code into the frontend and manipulate the DOM of this content however you like, it is extremely useful in case you are embedding Qadam Flow and want to have a way to communicate with the SaaS embedding it.
...
| isEmbedded | `boolean` | The flag that tells you if the code is running inside an embedded instance of Qadam Flow |
