...
Qadam Flow uses Zod for runtime validation of qadam properties. Zod provides a powerful schema validation system that helps ensure your qadam receives valid inputs.

To use Zod validation in your qadam, first import the validation helper and Zod:
