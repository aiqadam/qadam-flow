---
title: "Qadam Auth"
description: "Learn about qadam authentication"
icon: 'key'
---

Qadam authentication is used to gather user credentials and securely store them for future use in different flows.
