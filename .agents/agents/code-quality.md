...
The orchestrator runs the advisory pass before it spawns you and points you at the artifact in
`.git/qadam-review/last.json` (`comments[]`, each with file, line, rule and body). It is an input,
never the engine:
