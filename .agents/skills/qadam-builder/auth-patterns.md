...
**Real example:** `packages/qadams/community/stripe/src/index.ts`
...
export const myAppAuth = QadamAuth.OAuth2({
  required: true,
...
**Real example:** `packages/qadams/community/github/src/index.ts`, `packages/qadams/community/zoho-campaigns/` (OAuth2 with extra `props`)
...
export const myAppAuth = QadamAuth.BasicAuth({
...
export const myAppAuth = QadamAuth.CustomAuth({
  displayName: 'Connection',
  required: true,
  props: {
...
**Real example:** `packages/qadams/community/wordpress/src/index.ts`, `packages/qadams/community/mattermost/src/index.ts`
...
**Real example:** `packages/qadams/core/qrcode/src/index.ts`
