...
Always use `httpClient` from `@aiqadam/qadams-common`:
...
**Real examples:**
- `packages/qadams/community/github/src/lib/common/index.ts`
- `packages/qadams/community/stripe/src/lib/common/index.ts`
...
**Real example:** `packages/qadams/community/github/src/lib/common/index.ts` -- `githubPaginatedApiCall`
