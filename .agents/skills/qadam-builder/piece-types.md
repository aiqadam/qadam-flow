...
|---|---|---|
| `community/` | `@aiqadam/qadam-<name>` | `@aiqadam/qadam-slack` |
| `core/` | `@aiqadam/qadam-<name>` | `@aiqadam/qadam-http` |
...
Multiple categories allowed: `categories: [QadamCategory.COMMERCE, QadamCategory.PAYMENT_PROCESSING]`
