---
name: db-migration
description: Creates TypeORM database migrations for the Qadam Flow server. Use when the user asks to add a column, create a table, add an index, or make any schema change to the database.
---

# Qadam Flow DB Migration

Create TypeORM database migrations for schema changes in the Qadam Flow server API.
