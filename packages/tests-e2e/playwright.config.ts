...
const baseURL = process.env.AP_FRONTEND_URL ?? 'http://localhost:4200';
const useExternalServer = !!process.env.AP_FRONTEND_URL;
...
const config: PlaywrightTestConfig = {
   ...
   * Skipped when AP_FRONTEND_URL is set (e.g. running against docker compose stack). */
  ...(useExternalServer
    ? {}
    : {
      webServer: {
