import { ActionContext, ArrayProperty, CheckboxProperty, createAction, QadamAuthProperty, Property, ShortTextProperty, StaticDropdownProperty } from '@aiqadam/qadams-framework';
import { z } from 'zod';
import { propsValidation } from '@aiqadam/qadams-common';
import deepEqual from 'deep-equal';
import { common, getScopeAndKey, PieceStoreScope } from './common';

	async function executeStorageAddToList(context: ActionContext<QadamAuthProperty | undefined, {
