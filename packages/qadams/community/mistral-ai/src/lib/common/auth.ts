...
const mistralDirectAuth = QadamAuth.SecretText({
	displayName: 'API Key',
...
const mistralCloudflareGatewayAuth = QadamAuth.CustomAuth({
	...
	props: {
		...
		gatewayAuthToken: QadamAuth.SecretText({
		...
		mistralApiKey: QadamAuth.SecretText({
