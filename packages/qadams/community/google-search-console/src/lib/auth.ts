...
export const googleSearchConsoleAuth = QadamAuth.OAuth2({
  description: `
...
.Then finally click Save and Continue to finish the Test Users portion.
  ...
  12. Add https://flow.aiqadam.org/redirect in **Authorized redirect URIs** field, and click on the Create button.
