import { AppConnectionValueForAuthProperty, createTrigger, TriggerStrategy } from '@aiqadam/qadams-framework';
import { AuthenticationType, DedupeStrategy, httpClient, HttpMethod, Polling, pollingHelper } from '@aiqadam/qadams-common';
