...
export type InputProperty =
  ...
  | DropdownProperty<any, boolean, QadamAuthProperty | undefined | QadamAuthProperty[]>
  | StaticDropdownProperty<any, boolean>
  | NumberProperty<boolean>
  | ArrayProperty<boolean>
  | ObjectProperty<boolean>
  | JsonProperty<boolean>
  | MultiSelectDropdownProperty<any, boolean, QadamAuthProperty | undefined | QadamAuthProperty[]>
  | StaticMultiSelectDropdownProperty<any, boolean>
  | DynamicProperties<boolean, QadamAuthProperty | QadamAuthProperty[] | undefined>
...
export const Property = {
  ...
  Dropdown<T, R extends boolean = boolean, QadamAuth extends QadamAuthProperty | QadamAuthProperty[] |  undefined = undefined>(
    request: Properties<DropdownProperty<T, R, QadamAuth>>
  ): R extends true ? DropdownProperty<T, true, QadamAuth> : DropdownProperty<T, false, QadamAuth> {
    return {
      ...request,
      valueSchema: undefined,
      type: PropertyType.DROPDOWN,
    } as unknown as R extends true
      ? DropdownProperty<T, true, QadamAuth>
      : DropdownProperty<T, false, QadamAuth>;
  },
  ...
  MultiSelectDropdown<T, R extends boolean = boolean, QadamAuth extends QadamAuthProperty | QadamAuthProperty[] | undefined = undefined>(
    request: Properties<MultiSelectDropdownProperty<T, R, QadamAuth>>
  ): R extends true
    ? MultiSelectDropdownProperty<T, true, QadamAuth>
    : MultiSelectDropdownProperty<T, false, QadamAuth> {
    return {
      ...request,
      valueSchema: undefined,
  ...
  DynamicProperties<R extends boolean = boolean, QadamAuth extends QadamAuthProperty | QadamAuthProperty[] | undefined = undefined>(
    request: Properties<DynamicProperties<R,QadamAuth>>
  ): R extends true ? DynamicProperties<true, QadamAuth> : DynamicProperties<false, QadamAuth> {
    return {
      ...request,
      valueSchema: undefined,
      type: PropertyType.DYNAMIC,
    } as unknown as R extends true
      ? DynamicProperties<true, QadamAuth>
      : DynamicProperties<false, QadamAuth>;
  },
