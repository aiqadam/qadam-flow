...
import { QadamBase, QadamMetadata} from './qadam-metadata';
...
export class Qadam<Auth extends QadamAuthProperty | QadamAuthProperty[] | undefined = QadamAuthProperty>
  implements Omit<QadamBase, 'version' | 'name'>
{
  ...
  constructor(
    ...
    public readonly events: QadamEventProcessors | undefined,
    actions: Action[],
    triggers: Trigger[],
    public readonly categories: QadamCategory[],
  ...
  metadata(): BackwardCompatibleQadamMetadata {
    return {
...
export const createQadam = <Auth extends QadamAuthProperty | QadamAuthProperty[] | undefined>(
  params: CreateQadamParams<Auth>
) => {
...
type CreateQadamParams<
  Auth extends QadamAuthProperty | QadamAuthProperty[] | undefined = undefined
> = {
  displayName: string;
  logoUrl: string;
  authors: string[];
...
type BackwardCompatibleQadamMetadata = Omit<QadamMetadata, 'name' | 'version' | 'authors' | 'i18n' | 'getContextInfo'> & {
  authors?: QadamMetadata['authors']
  i18n?: QadamMetadata['i18n']
}
