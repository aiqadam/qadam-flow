...
export const qadamTranslation = {
  translatePiece: <T extends QadamMetadataModelSummary | QadamMetadataModel>(params: TranslatePieceParams<T>): T => {
    ...
    try {
      ...
      qadamTranslation.pathsToValuesToTranslate.forEach(key => {
...
type TranslatePieceParams<T extends QadamMetadataModelSummary | QadamMetadataModel> = {
  piece: T
  locale?: LocalesEnum
  mutate?: boolean
}
