  ...
  const technicalChecks = [
    {
              ...
              <>
                ...
                <span>
                  ...
                  <a
                    ...
                    href="https://github.com/aiqadam/qadam-flow/releases"
                    target="_blank"
      ...
      link: 'https://github.com/aiqadam/qadam-flow/releases',
    },
    {
      id: 'disk-size',
      title: t('Disk Size'),
      ...
      message: (
        <span>
          {systemHealth?.disk
            ...
            : t(
                'Insufficient disk space. A minimum of 30GB is required for Qadam Flow to function properly.',
              )}
        </span>
      ),
      loading: isPending,
      link: 'https://flow.aiqadam.org/docs/install/configuration/hardware#technical-specifications',
    },
    {
      id: 'ram',
      title: t('RAM'),
    ...
    },
    {
      ...
      message: (
        <span>
          {systemHealth?.cpu
            ? t(
                'The server has enough CPU resources. At least 1 CPU core is required to run Qadam Flow.',
              )
            : t(
                'Not enough CPU resources. At least 1 CPU core is necessary to operate Qadam Flow.',
              )}
        </span>
      ),
      link: 'https://flow.aiqadam.org/docs/install/configuration/hardware#technical-specifications',
