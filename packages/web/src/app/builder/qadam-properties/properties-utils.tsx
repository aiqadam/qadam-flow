...
import { isNil, PropertySettings } from '@aiqadam/shared';
...
import { ArrayQadamProperty } from './array-property';
...
import { DynamicDropdownQadamProperty } from './dynamic-dropdown-qadam-property';
import { DynamicProperties } from './dynamic-qadam-property';
      ...
      return (
        ...
        >
          {isNil(dynamicPropsInfo) ? (
            ...
            <DynamicDropdownQadamProperty
              refreshers={property.refreshers}
              value={field.value}
              actionOrTriggerName={dynamicPropsInfo.actionOrTriggerName}
              qadamName={dynamicPropsInfo.qadamName}
              qadamVersion={dynamicPropsInfo.qadamVersion}
              form={form}
  ...
  dynamicPropsInfo:
    | ({
        ...
        | {
            ...
            updateFormSchema: (
              key: string,
              newFieldSchema: QadamPropertyMap,
            ) => void;
            updatePropertySettingsSchema: (
