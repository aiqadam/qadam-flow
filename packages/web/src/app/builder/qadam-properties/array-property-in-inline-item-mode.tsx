import { ArraySubProps } from '@aiqadam/qadams-framework';
...
type ArrayQadamPropertyInInlineItemModeProps = BaseArrayPropertyProps &
  (
...
const ArrayQadamPropertyInInlineItemMode = React.memo(
  (props: ArrayQadamPropertyInInlineItemModeProps) => {
...
ArrayQadamPropertyInInlineItemMode.displayName =
  'ArrayQadamPropertyInInlineItemMode';
export { ArrayQadamPropertyInInlineItemMode };
