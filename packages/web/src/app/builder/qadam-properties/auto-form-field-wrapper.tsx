...
import { ArrayQadamPropertyInInlineItemMode } from './array-property-in-inline-item-mode';
...
function AutoFormFieldWrapper({
  ...
  const isArrayProperty =
    !isQadamAuthProperty(property) && property.type === PropertyType.ARRAY;
    ...
    >
      <FormItem className="flex flex-col">
        ...
        {isArrayProperty && dynamicInputModeToggled && (
          <ArrayQadamPropertyInInlineItemMode
            disabled={disabled}
...
function getValueForInputOnDynamicToggleChange(
  property: QadamProperty | QadamAuthProperty[],
  newMode: PropertyExecutionType,
  currentValue: unknown,
) {
  const isAuthProperty = isQadamAuthProperty(property);
  switch (newMode) {
...
function PropertyTypeTooltip({ property }: { property: QadamProperty }) {
  if (
...
type AutoFormFielWrapperErrorBoundaryProps = {
  ...
  property: QadamProperty | QadamAuthProperty[] | null;
  dynamicInputModeToggled?: boolean;
};
...
function isQadamAuthProperty(
  property: QadamProperty | QadamAuthProperty[],
): property is QadamAuthProperty[] {
