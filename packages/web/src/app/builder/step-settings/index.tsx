...
const StepSettingsContainer = () => {
  ...
  const isManualTrigger =
    ...
    qadamSelectorUtils.isManualTrigger({
      qadamName: modifiedStep.settings.qadamName,
  ...
  const runAgentStep =
    modifiedStep.settings.qadamName === '@aiqadam/qadam-ai' &&
          ...
          <SidebarHeader
            ...
            actions={
              <div className="flex items-center gap-1">
                {isQadamMetadata(stepMetadata) &&
                  stepMetadata.qadamVersion &&
                  (modifiedStep.type === FlowActionType.PIECE ||
                    modifiedStep.type === FlowTriggerType.PIECE) && (
                    <PieceVersionInHeader
                      step={modifiedStep}
                      qadamVersion={stepMetadata.qadamVersion}
                      readonly={readonly}
                    />
                  )}
...
const PieceVersionInHeader = ({
  ...
  const exactVersion = flowQadamUtil.getExactVersion(qadamVersion);
  const showSwitcher =
    !readonly &&
