import { AgentToolType, AIProviderName } from '@aiqadam/shared';
import type {
...
import {
  ...
  AgentQadamToolComponent,
  AgentFlowToolDialog,
  AgentMcpDialog,
  KnowledgeBaseSection,
} from '@/features/agents';

import { AgentPieceDialog } from './qadam-tool-dialog';

const icons = [
  '/assets/qadams/youtube.png',
  '/assets/qadams/slack.png',
  '/assets/qadams/github.png',
  '/assets/qadams/notion.png',
];
      ...
      <div className="mt-2">
        ...
        0 ? (
          <>
            ...
            >
              {Object.entries(pieceToToolMap).map(([qadamName, tools]) => (
                <AgentQadamToolComponent
                  key={qadamName}
                  disabled={disabled}
                  tools={tools}
