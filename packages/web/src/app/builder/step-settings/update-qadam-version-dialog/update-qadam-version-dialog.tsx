import { formErrors, QadamAction, QadamTrigger } from '@aiqadam/shared';
...
import {
  ...
  VersionChangeType,
} from './update-qadam-version-utils';
import { UpgradePieceVersionContent } from './upgrade-qadam-version-dialog';
...
const AdvancedForm: React.FC<AdvancedFormProps> = ({
  ...
  const patchVersions = (qadamVersions ?? []).filter((p) => {
