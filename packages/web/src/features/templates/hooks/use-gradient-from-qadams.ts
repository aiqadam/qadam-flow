...
import { StepMetadata } from '@/features/qadams/types';
import { extractQadamNamesAndCoreMetadata } from '@/features/qadams/utils/step-utils';
...
export const useGradientFromPieces = (
  ...
  const uniqueMetadata: StepMetadata[] = useMemo(() => {
    ...
    const allMetadata = [...coreMetadata, ...qadamMetadata];
