import { OAuth2Property, OAuth2Props } from '@aiqadam/qadams-framework';
import {
  AppConnectionType,
...
function getPredefinedOAuth2App(
  ...
  const pieceOAuth2Apps = piecesOAuth2AppsMap[qadamName];
...
export type QadamsOAuth2AppsMap = Record<
  string,
  | {
