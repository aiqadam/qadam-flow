...
import { QadamIconList } from '@/features/qadams/components/qadam-icon-list';
...
import { useGradientFromPieces } from '@/features/templates/hooks/use-gradient-from-qadams';
