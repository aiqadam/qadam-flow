...
export enum AppSystemProp {
    ...
    LDAP_ALLOW_LIST = 'LDAP_ALLOW_LIST',
    LDAP_RECONCILE_ENABLED = 'LDAP_RECONCILE_ENABLED',
    LDAP_RECONCILE_CRON = 'LDAP_RECONCILE_CRON',
    LDAP_RECONCILE_SAFETY_VALVE_PERCENT = 'LDAP_RECONCILE_SAFETY_VALVE_PERCENT',
    LDAP_RECONCILE_PLATFORM_TIME_BUDGET_MS = 'LDAP_RECONCILE_PLATFORM_TIME_BUDGET_MS',
    LOAD_TRANSLATIONS_FOR_DEV_QADAMS = 'LOAD_TRANSLATIONS_FOR_DEV_QADAMS',
    LOG_LEVEL = 'LOG_LEVEL',
    LOG_PRETTY = 'LOG_PRETTY',
    LOKI_PASSWORD = 'LOKI_PASSWORD',
    LOKI_URL = 'LOKI_URL',
    LOKI_USERNAME = 'LOKI_USERNAME',
    MAX_CUSTOM_AI_PROVIDERS_PER_PLATFORM = 'MAX_CUSTOM_AI_PROVIDERS_PER_PLATFORM',
    MAX_FIELDS_PER_TABLE = 'MAX_FIELDS_PER_TABLE',
    MAX_FILE_SIZE_MB = 'MAX_FILE_SIZE_MB',
    MAX_FLOW_RUN_LOG_SIZE_MB = 'MAX_FLOW_RUN_LOG_SIZE_MB',
    LOOP_MAX_CONCURRENCY = 'LOOP_MAX_CONCURRENCY',
    ...
    MAX_TEAM_PROJECTS_PER_PLATFORM = 'MAX_TEAM_PROJECTS_PER_PLATFORM',
    OFFICIAL_QADAMS_INSTALL_ENABLED = 'OFFICIAL_QADAMS_INSTALL_ENABLED',
    ...
    SYNC_WEBHOOK_BACKPRESSURE_ENABLED = 'SYNC_WEBHOOK_BACKPRESSURE_ENABLED',
    SYNC_WEBHOOK_BACKPRESSURE_RETRY_AFTER_SECONDS = 'SYNC_WEBHOOK_BACKPRESSURE_RETRY_AFTER_SECONDS',
    ...
    TRIGGER_LONG_POLLING_ENABLED = 'TRIGGER_LONG_POLLING_ENABLED',
