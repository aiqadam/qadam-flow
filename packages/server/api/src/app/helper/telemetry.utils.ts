...
import { ProjectId, TelemetryEvent, User, UserId, UserIdentity } from '@aiqadam/shared'
...
async function getMetadata() {
    ...
    return {
        qadamFlowVersion: currentVersion,
        qadamFlowEnvironment: system.get(AppSystemProp.ENVIRONMENT),
    }
}
