...
export const apAddStepTool = (mcp: ProjectScopedMcpServer, log: FastifyBaseLogger): McpToolDefinition => {
    return {
        ...
        inputSchema: {
            ...
            qadamName: z.string().optional().describe('For PIECE steps: the piece name (e.g. "@aiqadam/qadam-gmail"). Use ap_research_pieces to get valid values.'),
                ...
                case FlowActionType.PIECE: {
                    if (!qadamName) {
                        return {
                            content: [{
                                type: 'text',
                                text: '❌ qadamName is required for PIECE steps. Use ap_research_pieces to get valid values.',
                            }],
                        }
                    }
                    ...
                    const pieceSettings: Record<string, unknown> = {
                        qadamName: versionResult.normalizedPieceName,
                        qadamVersion: versionResult.qadamVersion,
