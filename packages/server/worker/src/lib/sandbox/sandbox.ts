...
import { assertNotNullOrUndefined, createNotifyServer, createRpcClient, createRpcServer, EngineContract, EngineOperation, EngineOperationType, EngineResponse, EngineStderr, EngineStdout, ErrorCode, isNil, QadamFlowError, WorkerContract, WorkerNotifyContract } from '@aiqadam/shared'
...
type ProcessExitParams = {
    ...
    stdOut: string
    stdError: string
    reject: (error: QadamFlowError) => void
}
