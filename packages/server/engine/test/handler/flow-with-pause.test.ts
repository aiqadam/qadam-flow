import { BranchOperator, FlowRunStatus, LoopStepOutput, RouterExecutionType, RouterStepOutput } from '@aiqadam/shared'
...
const simplePauseFlow = buildQadamAction({
    name: 'approval',
...
const flawWithTwoPause = buildQadamAction({
    name: 'approval',
    qadamName: '@aiqadam/qadam-approval',
    actionName: 'wait_for_approval',
    input: {},
