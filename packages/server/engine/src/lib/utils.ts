...
import { ConnectionsManager, ContextVersion, RespondHookParams, StopHookParams } from '@aiqadam/qadams-framework'
import { ExecutionError, ExecutionErrorType, formatQadamError, RespondResponse, Result, tryCatch } from '@aiqadam/shared'
...
export const utils = {
    ...
    formatExecutionError(value: ExecutionError): string {
        return JSON.stringify(formatQadamError(value, { raw: inspect(value) }))
    },
