import { getAuthPropertyForValue, InputPropertyMap, PropertyType, QadamAuthProperty, QadamProperty, QadamPropertyMap, StaticPropsValue } from '@aiqadam/qadams-framework'
import { AppConnectionValue, AUTHENTICATION_PROPERTY_NAME, isNil, isObject, PropertySettings } from '@aiqadam/shared'
...
export const propsProcessor = {
    ...
    ): Promise<{ processedInput: StaticPropsValue<QadamPropertyMap>, errors: PropsValidationError }> => {
