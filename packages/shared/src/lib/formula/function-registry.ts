export const AP_FUNCTIONS: ApFunction[] = [
    ...
    },
    {
        name: 'filter_list',
        category: 'list',
        description: 'Keeps only the items where a field matches a value. The optional operator can be equals, not_equals, contains, starts_with, ends_with, greater_than, less_than, or in.',
        syntax: 'filter_list(list; field; value; operator)',
        example: 'filter_list( files ; name; .pdf; ends_with )',
        exampleResult: '[3 of 10 items]',
        minArgs: 3,
        maxArgs: 4,
        argTypes: ['list', 'string', ['string', 'number', 'boolean', 'list'], 'string'],
        returnType: 'list',
    },
    {
        name: 'sort_list',
    ...
    },
    {
        name: 'pluck',
        category: 'list',
        description: 'Picks one field out of every item in a list. Use a dotted path for nested fields.',
    ...
    },
    {
        name: 'find_by',
        category: 'list',
        description: 'Returns the first item in a list whose field matches a value.',
        syntax: 'find_by(list; field; value)',
        example: 'find_by( users ; id; 42 )',
        exampleResult: '{ id: 42, name: Bob }',
        minArgs: 3,
        maxArgs: 3,
    ...
    },
    {
        name: 'keys',
        category: 'list',
        description: 'Returns the list of field names in an object.',
        syntax: 'keys(object)',
        example: 'keys( { name: Bob, age: 30 } )',
        exampleResult: '[name, age]',
        minArgs: 1,
        maxArgs: 1,
        argTypes: ['list'],
        returnType: 'list',
    },
    {
        name: 'values',
        category: 'list',
        description: 'Returns the list of values in an object.',
        syntax: 'values(object)',
        example: 'values( { name: Bob, age: 30 } )',
        exampleResult: '[Bob, 30]',
        minArgs: 1,
        maxArgs: 1,
        argTypes: ['list'],
        returnType: 'list',
    },
    {
        name: 'to_json',
        category: 'list',
        description: 'Turns an object or list into a JSON text string.',
        syntax: 'to_json(value)',
        example: 'to_json( { id: 42 } )',
        exampleResult: '{"id":42}',
        minArgs: 1,
        maxArgs: 1,
    ...
    },
    {
        name: 'from_json',
        category: 'list',
        description: 'Parses a JSON text string back into an object or list.',
        syntax: 'from_json(text)',
        example: 'from_json( {"id":42} )',
        exampleResult: '{ id: 42 }',
        minArgs: 1,
        maxArgs: 1,
        argTypes: ['string'],
