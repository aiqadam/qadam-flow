...
export function isManualQadamTrigger({ qadamName, triggerName }: { qadamName: string, triggerName: string }) {
    return qadamName === '@aiqadam/qadam-manual-trigger' && triggerName === 'manual_trigger'
}
