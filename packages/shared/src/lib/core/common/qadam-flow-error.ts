...
export class QadamFlowError extends Error {
...
export type ApErrorParams =
    ...
    | QadamSyncNotSupportedErrorParams
...
export type QadamSyncNotSupportedErrorParams = BaseErrorParams<ErrorCode.QADAM_SYNC_NOT_SUPPORTED, {
    release: string
    message: string
}>
...
export enum ErrorCode {
    ...
    QADAM_SYNC_NOT_SUPPORTED = 'QADAM_SYNC_NOT_SUPPORTED',
