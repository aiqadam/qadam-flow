...
export enum ApFlagId {
    ...
    // What the server will wait for a provider, so the browser can outlast it rather than guess.
    HTTP_FIRST_BYTE_TIMEOUT_SECONDS = 'HTTP_FIRST_BYTE_TIMEOUT_SECONDS',
    HTTP_STREAM_IDLE_TIMEOUT_SECONDS = 'HTTP_STREAM_IDLE_TIMEOUT_SECONDS',
