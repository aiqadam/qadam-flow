...
import { FilteredQadamBehavior } from './platform.model'
...
export const UpdatePlatformRequestBody = z.object({
    ...
    filteredQadamNames: OptionalArrayFromQuery(z.string()),
    filteredQadamBehavior: z.nativeEnum(FilteredQadamBehavior).optional(),
    ...
    pinnedQadams: OptionalArrayFromQuery(z.string()),
