...
import { EmptyTrigger, FlowTrigger, FlowTriggerType, QadamTrigger, QadamTriggerSettings } from '../triggers/trigger'
        ...
        switch (operation.type) {
            ...
            case FlowOperationType.ADD_ACTION: {
                if (operation.request.action.type === FlowActionType.PIECE) {
                    operation.request.action.settings.qadamVersion = flowQadamUtil.getExactVersion(operation.request.action.settings.qadamVersion)
                }
            ...
            case FlowOperationType.UPDATE_TRIGGER: {
                if (operation.request.type === FlowTriggerType.PIECE) {
                    operation.request.settings.qadamVersion = flowQadamUtil.getExactVersion(operation.request.settings.qadamVersion)
                }
