import { CodeAction, FlowAction, FlowActionType, QadamAction } from '../actions/action'
...
function hasContinueOnFailureBranches(step: Step | FlowAction): step is CodeAction | QadamAction {
...
function getContinueOnFailureBranchPair(step: CodeAction | QadamAction): (FlowAction | undefined)[] {
