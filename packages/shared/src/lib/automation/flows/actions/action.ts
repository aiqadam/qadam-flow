...
const qadamActionSettingsFields = {
    ...commonActionSettings,
...
export const QadamActionSettings = z.object({
    ...qadamActionSettingsFields,
})

export type QadamActionSettings = z.infer<typeof QadamActionSettings>

export const QadamActionSchema = z.object({
    ...commonActionProps,
...
export type FlowAction =
    ...
    | (BaseActionProps & { type: FlowActionType.PIECE, settings: QadamActionSettings, nextAction?: FlowAction, continueOnFailureBranches?: ContinueOnFailureBranches })
...
export type QadamAction = BaseActionProps & {
