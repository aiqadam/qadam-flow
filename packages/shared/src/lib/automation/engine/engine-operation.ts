...
import { QadamPackage } from '../qadams'
...
export type ExecuteExtractQadamMetadata = QadamPackage & { platformId: PlatformId }

export type ExecuteExtractQadamMetadataOperation = ExecuteExtractQadamMetadata & { timeoutInSeconds: number, platformId: PlatformId }
