...
export const ExecuteExtractQadamMetadataJobData = z.object({
    schemaVersion: z.number(),
...
export type ExecuteExtractQadamMetadataJobData = z.infer<typeof ExecuteExtractQadamMetadataJobData>
...
export const UserInteractionJobDataWithoutWatchingInformation = z.union([
    ...
    ExecuteExtractQadamMetadataJobData.omit({ schemaVersion: true, requestId: true, webserverId: true }),
])
